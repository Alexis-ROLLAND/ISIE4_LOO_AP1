...
class Bit {
  public:
     ...
     */
    enum class bit_t : std::int8_t {
        SET,   /**< Bit is SET (High, '1',...)		*/
  ...
  public:
     ...
     * 	[[nodiscard]] here for preventing users to get rid of the return value (compiler warning in this case).
     *
     *  @return String reprsenting the Bit value. Using the string_view type in place of "classic" string to avoit
     * object copy for const strings.
     */
